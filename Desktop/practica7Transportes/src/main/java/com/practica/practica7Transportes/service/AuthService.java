...
import com.practica.practica7Transportes.repository.UserRepository;
import com.practica.practica7Transportes.security.JwtTokenProvider;
...
public class AuthService {
    ...
    public Map<String, Object> register(String username, String password, String email) {
        return register(username, password, email, User.Role.TRANSPORTISTA);
    }
